...
# Generated automatically by Terraform for dev environment
...
Available Secrets for $PROJECT_NAME-$ENVIRONMENT:    - aeims/dev/aeims_app/database    - aeims/dev/aeims_core/database
EOF
}
